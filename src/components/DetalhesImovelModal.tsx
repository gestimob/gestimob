                        ...
                        <div className="px-5 sm:px-8 py-5 sm:py-6 border-b border-panel-border flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 bg-panel/30 dark:bg-white/5 backdrop-blur-md z-20">
                            ...
                            <div className="flex items-center justify-between sm:justify-end gap-4 sm:gap-6 pt-4 sm:pt-0 border-t sm:border-0 border-panel-border">
                                <div className="flex flex-col items-start sm:items-center">
                                    <span className="text-[8px] sm:text-[9px] font-black text-accent uppercase tracking-widest mb-0.5 sm:mb-1.5">STATUS DO IMÓVEL</span>
                                    <span className={cn("text-[10px] sm:text-[10px] font-black uppercase tracking-widest px-3 sm:px-4 py-1 sm:py-1.5 rounded-full border",
                                ...
                                <div className="flex items-center gap-2">
                                    <button onClick={handlePrint} className="flex items-center gap-2 bg-black/5 dark:bg-white/5 border border-panel-border text-foreground hover:bg-black/10 dark:hover:bg-white/10 px-4 sm:px-6 py-2 sm:py-2.5 rounded-xl text-[9px] sm:text-[10px] font-black uppercase tracking-widest transition-all no-print shadow-sm">
                                        <Printer className="w-4 h-4" /> <span className="hidden sm:inline">Imprimir</span>
                                    </button>
                                    <button onClick={onClose} className="hidden sm:flex w-10 h-10 items-center justify-center rounded-xl bg-black/5 dark:bg-white/5 border border-panel-border text-accent hover:text-foreground no-print shadow-sm">
                                        <X className="w-5 h-5" />
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-12 gap-10">
                                ...
                                <div className="col-span-12 lg:col-span-5 flex flex-col gap-8">
                                    ...
                                    <div className="bg-black/5 dark:bg-white/5 border border-panel-border rounded-[24px] sm:rounded-[32px] p-6 sm:p-8">
                                        <h3 className="text-[9px] sm:text-[10px] font-black text-accent uppercase tracking-[0.2em] mb-6 flex items-center gap-3"><Building2 className="w-4 h-4 text-primary" /> CARACTERÍSTICAS</h3>

                                        <div className="grid grid-cols-2 gap-3 sm:gap-4">
                                            <div className="bg-background border border-panel-border rounded-xl sm:rounded-2xl py-3 sm:py-4 px-4 sm:px-6 shadow-sm flex items-center justify-center text-center">
                                                <span className="text-[10px] sm:text-xs font-black text-accent uppercase tracking-wider mr-2">Área:</span>
                                                <span className="text-xs sm:text-sm font-black text-foreground">{Number(imovel.area_m2 || 0)} m²</span>
                                            </div>
                                            <div className="bg-background border border-panel-border rounded-xl sm:rounded-2xl py-3 sm:py-4 px-4 sm:px-6 shadow-sm flex items-center justify-center text-center">
                                                <span className="text-[10px] sm:text-xs font-black text-accent uppercase tracking-wider mr-2">Quartos:</span>
                                                <span className="text-xs sm:text-sm font-black text-foreground">{imovel.quartos || 0}</span>
                                            </div>
                                            <div className="bg-background border border-panel-border rounded-xl sm:rounded-2xl py-3 sm:py-4 px-4 sm:px-6 shadow-sm flex items-center justify-center text-center">
                                                <span className="text-[10px] sm:text-xs font-black text-accent uppercase tracking-wider mr-2">Suítes:</span>
                                                <span className="text-xs sm:text-sm font-black text-foreground">{imovel.suites || 0}</span>
                                            </div>
                                            <div className="bg-background border border-panel-border rounded-xl sm:rounded-2xl py-3 sm:py-4 px-4 sm:px-6 shadow-sm flex items-center justify-center text-center">
                                                <span className="text-[10px] sm:text-xs font-black text-accent uppercase tracking-wider mr-2">Banheiros:</span>
                                                <span className="text-xs sm:text-sm font-black text-foreground">{imovel.banheiros || 0}</span>
                                            </div>
                                            <div className="bg-background border border-panel-border rounded-xl sm:rounded-2xl py-3 sm:py-4 px-4 sm:px-6 shadow-sm flex items-center justify-center text-center">
                                                <span className="text-[10px] sm:text-xs font-black text-accent uppercase tracking-wider mr-2">Vagas:</span>
                                                <span className="text-xs sm:text-sm font-black text-foreground">{imovel.vagas || 0}</span>
                                            </div>
                                            {imovel.andar_imovel && (
                                                <div className="bg-background border border-panel-border rounded-xl sm:rounded-2xl py-3 sm:py-4 px-4 sm:px-6 shadow-sm flex items-center justify-center text-center">
                                                    <span className="text-[10px] sm:text-xs font-black text-accent uppercase tracking-wider mr-2">Andar:</span>
                                                    <span className="text-xs sm:text-sm font-black text-foreground">{imovel.andar_imovel}</span>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                                ...
                                <div className="col-span-12 lg:col-span-7 space-y-8">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
                                            <div className="space-y-2 sm:space-y-4">
                                                <div className="space-y-1 text-center">
                                                    <p className="text-[9px] sm:text-[10px] font-black text-accent uppercase tracking-widest">Valor Aluguel R$</p>
                                                    <p className="text-2xl sm:text-3xl font-serif-premium font-bold text-white">R$ {Number(imovel.valor_aluguel || 0).toLocaleString('pt-br', { minimumFractionDigits: 2 })}</p>
                                                </div>
                                            </div>
                                            <div className="space-y-2 sm:space-y-4">
                                                <div className="space-y-1 text-center">
                                                    <p className="text-[9px] sm:text-[10px] font-black text-accent uppercase tracking-widest">Valor Condomínio R$</p>
                                                    <p className="text-xl sm:text-2xl font-serif-premium font-bold text-foreground">R$ {Number(imovel.valor_condominio || 0).toLocaleString('pt-br', { minimumFractionDigits: 2 })}</p>
                                                </div>
                                            </div>
                                            <div className="col-span-1 sm:col-span-2 flex justify-center mt-2">
                                                <div className="inline-flex items-center gap-2 px-4 sm:px-6 py-2 bg-background border border-panel-border rounded-xl shadow-sm">
                                                    <span className="text-[9px] sm:text-[10px] font-black uppercase text-accent tracking-widest">Tipo Local:</span>
                                                    <span className="text-xs sm:text-sm font-black text-foreground">{imovel.tipo_aluguel || 'Residencial'}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    {/* Endereço */}
                                    <div className="bg-black/5 dark:bg-white/5 border border-panel-border rounded-[24px] sm:rounded-[32px] p-6 sm:p-8">
                                        <h3 className="text-[9px] sm:text-[10px] font-black text-accent uppercase tracking-[0.2em] mb-6 flex items-center gap-3"><MapPin className="w-4 h-4 text-primary" /> LOCALIZAÇÃO</h3>

                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 sm:gap-y-8 gap-x-6 sm:gap-x-12">
                                            <div className="space-y-1 sm:col-span-2">
                                                <p className="text-[9px] sm:text-[10px] font-black text-accent uppercase tracking-widest">Logradouro Completo</p>
                                                <p className="text-xs sm:text-sm font-bold text-foreground">{imovel.logradouro || '-'} {imovel.numero ? `, Nº ${imovel.numero}` : ''} {imovel.complemento ? `(${imovel.complemento})` : ''}</p>
                                            </div>
                                            <div className="space-y-1">
                                                <p className="text-[9px] sm:text-[10px] font-black text-accent uppercase tracking-widest">Bairro</p>
                                                <p className="text-xs sm:text-sm font-bold text-foreground">{imovel.bairro || '-'}</p>
                                            </div>
                                            <div className="space-y-1">
                                                <p className="text-[9px] sm:text-[10px] font-black text-accent uppercase tracking-widest">CEP</p>
                                                <p className="text-xs sm:text-sm font-bold text-foreground">{imovel.cep || '-'}</p>
                                            </div>
                                            <div className="space-y-1">
                                                <p className="text-[9px] sm:text-[10px] font-black text-accent uppercase tracking-widest">Cidade</p>
                                                <p className="text-xs sm:text-sm font-bold text-foreground">{imovel.cidade || '-'}</p>
                                            </div>
                                            <div className="space-y-1">
                                                <p className="text-[9px] sm:text-[10px] font-black text-accent uppercase tracking-widest">UF</p>
                                                <p className="text-xs sm:text-sm font-bold text-foreground">{imovel.estado || '-'}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-black/5 dark:bg-white/5 border border-panel-border rounded-[24px] sm:rounded-[32px] p-6 sm:p-8">
                                        <h3 className="text-[9px] sm:text-[10px] font-black text-accent uppercase tracking-[0.2em] mb-6 flex items-center gap-3"><FileBox className="w-4 h-4 text-primary" /> REGISTROS OFICIAIS</h3>

                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 sm:gap-y-8 gap-x-6 sm:gap-x-12">
                                            <div className="space-y-1">
                                                <p className="text-[9px] sm:text-[10px] font-black text-accent uppercase tracking-widest">Inscrição IPTU</p>
                                                <p className="text-xs sm:text-[13px] font-bold text-foreground">
                                            ...
                                            <div className="space-y-1">
                                                <p className="text-[9px] sm:text-[10px] font-black text-accent uppercase tracking-widest">Matrícula</p>
                                                <p className="text-xs sm:text-[13px] font-bold text-foreground">{imovel.num_matricula || 'N/A'}</p>
                                            </div>
                                            <div className="space-y-1">
                                                <p className="text-[9px] sm:text-[10px] font-black text-accent uppercase tracking-widest">Nº Energisa</p>
                                                <p className="text-xs sm:text-[13px] font-bold text-foreground">{imovel.num_energisa || 'N/A'}</p>
                                            </div>
                                            <div className="space-y-1">
                                                <p className="text-[9px] sm:text-[10px] font-black text-accent uppercase tracking-widest">Nº CAGEPA</p>
                                                <p className="text-xs sm:text-[13px] font-bold text-foreground">{imovel.num_cagepa || 'N/A'}</p>
                                            </div>

                                            {imovel.arquivo_matricula_url && (
                                                <div className="col-span-1 sm:col-span-2 pt-4 border-t border-panel-border">
                                                    <a href={imovel.arquivo_matricula_url} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-4 bg-background border border-panel-border rounded-xl sm:rounded-2xl hover:border-primary transition-all group no-print">
                                                        <div className="flex items-center gap-4 min-w-0">
                                                            <div className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center border border-white/20 group-hover:bg-white group-hover:text-white text-white transition-all shrink-0">
                                                                <FileText className="w-5 h-5" />
                                                            </div>
                                                            <div className="min-w-0">
                                                                <p className="text-xs sm:text-sm font-bold text-foreground truncate">Arquivo Matrícula</p>
                                                                <p className="text-[8px] sm:text-[10px] font-black uppercase text-accent tracking-widest mt-0.5 truncate">Digitalizado</p>
                                                            </div>
                                                        </div>
                                            ...
                                            {imovel.iptu_pdf_url && (
                                                <div className="col-span-1 sm:col-span-2 pt-4 border-t border-panel-border">
                                                    <a href={imovel.iptu_pdf_url} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-4 bg-background border border-panel-border rounded-xl sm:rounded-2xl hover:border-primary transition-all group no-print">
                                                        <div className="flex items-center gap-4 min-w-0">
                                                            <div className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center border border-white/20 group-hover:bg-white group-hover:text-white text-white transition-all shrink-0">
                                                                <FileBox className="w-5 h-5" />
                                                            </div>
                                                            <div className="min-w-0">
                                                                <p className="text-xs sm:text-sm font-bold text-foreground truncate">Boleto IPTU</p>
                                                                <p className="text-[8px] sm:text-[10px] font-black uppercase text-accent tracking-widest mt-0.5 truncate">Arrecadação</p>
                                                            </div>
                                                        </div>
                                                        <ExternalLink className="w-4 h-4 text-accent group-hover:text-primary transition-colors shrink-0" />
                                                    </a>
