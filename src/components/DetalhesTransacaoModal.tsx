            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 20 }}
                        className="bg-panel glass-elite w-full max-w-2xl max-h-[90vh] flex flex-col rounded-[48px] shadow-2xl relative z-10 border border-panel-border overflow-hidden">
                        ...
                        <header className="px-10 py-6 flex justify-between items-center bg-gradient-to-b from-black/5 dark:from-white/5 to-transparent border-b border-panel-border shrink-0">
                            <div>
                                <h3 className="text-2xl font-serif-premium font-bold text-foreground lowercase first-letter:uppercase italic tracking-tighter">Detalhes da Transação</h3>
                                <p className="text-[10px] uppercase font-black tracking-widest text-foreground mt-1">CÓD INTERNO: {transacao.codigo_transacao || '----'}</p>
                            </div>
                        ...
                        <div className="p-10 space-y-10 flex-1 overflow-y-auto custom-scrollbar">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-white/[0.02] border border-panel-border rounded-2xl p-4">
                                        <div className="flex items-center gap-2 mb-1">
                                            <Calendar className="w-3.5 h-3.5 text-accent" />
                                            <span className="text-[10px] font-black text-text-dim uppercase tracking-widest">Data de Geração</span>
                                        </div>
                                        <p className="text-[13px] font-bold text-foreground">{formatDate(transacao.created_at)}</p>
                                    </div>

                                    <div className="bg-white/[0.02] border border-panel-border rounded-2xl p-4">
                                        <div className="flex items-center gap-2 mb-1">
                                            <Hash className="w-3.5 h-3.5 text-accent" />
                                            <span className="text-[10px] font-black text-text-dim uppercase tracking-widest">Quantidade de Parcelas</span>
                                        </div>
                                        <p className="text-[13px] font-bold text-foreground">{transacao.quantidade_parcelas}x</p>
                                    </div>

                                    <div className="bg-white/[0.02] border border-panel-border rounded-2xl p-4">
                                        <div className="flex items-center gap-2 mb-1">
                                            <DollarSign className="w-3.5 h-3.5 text-accent" />
                                            <span className="text-[10px] font-black text-text-dim uppercase tracking-widest">Valor da Parcela</span>
                                        </div>
                                        <p className="text-[13px] font-black text-white">{formatBRL(transacao.valor_parcela)}</p>
                                    </div>

                                    <div className="bg-white/[0.02] border border-panel-border rounded-2xl p-4">
                                        <div className="flex items-center gap-2 mb-1">
                                            <DollarSign className="w-3.5 h-3.5 text-accent" />
                                            <span className="text-[10px] font-black text-text-dim uppercase tracking-widest">Valor Adicional</span>
                                        </div>
                                        <p className="text-[13px] font-black text-amber-500">{formatBRL(transacao.valor_adicional)}</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="bg-white/[0.02] border border-panel-border rounded-2xl p-4">
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            <span className="text-[10px] font-black text-text-dim uppercase tracking-widest">Contrato Vinculado</span>
                                        </div>
                                        <p className="text-[13px] font-bold text-foreground">{transacao.contrato_codigo || 'Nenhum'}</p>
                                    </div>

                                    <div className="bg-white/[0.02] border border-panel-border rounded-2xl p-4">
                                        <div className="flex items-center gap-2 mb-1">
                                            <FileText className="w-3.5 h-3.5 text-accent" />
                                            <span className="text-[10px] font-black text-text-dim uppercase tracking-widest">Aluguel Vinculado</span>
                                        </div>
                                        <p className="text-[13px] font-bold text-foreground">{transacao.aluguel_codigo || 'Nenhum'}</p>
                                    </div>

                                    <div className="col-span-1 md:col-span-2 bg-white/[0.02] border border-panel-border rounded-2xl p-4">
                                        <div className="flex items-center gap-2 mb-1">
                                            <User className="w-3.5 h-3.5 text-accent" />
                                            <span className="text-[10px] font-black text-text-dim uppercase tracking-widest">Locatário</span>
                                        </div>
                                        <p className="text-[13px] font-bold text-foreground">{transacao.locatario_nome || '---'}</p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="flex items-center gap-4 text-xs font-bold text-accent">
                                        ...
                                        <label className="flex items-center gap-2 cursor-pointer group">
                                            <input type="radio"
                                                ...
                                                className="w-4 h-4 accent-primary" />
                                            <span className="group-hover:text-foreground transition-colors">Boletos Mensais</span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                {loadingParcelas ? (
                                    ...
                                    <div className="space-y-6">
                                        {uploadItems.map((item, index) => (
                                            <div key={item.id} className="bg-white/[0.02] border border-panel-border rounded-3xl p-6 space-y-4">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
                                                    ...
                                                    <div className="col-span-1 md:col-span-5 space-y-2">
                                                        <label className="text-[10px] font-black text-text-dim uppercase tracking-widest ml-1">Arquivo (PDF/PNG)</label>
                                                        {item.file ? (
                                                            <div className="flex items-center gap-3 p-2 bg-white/5 border border-panel-border rounded-xl h-[36px]">
                                                                ...
                                                                <div className="flex-1 min-w-0 flex justify-between items-center">
                                                                    <p className="text-[10px] font-bold text-foreground truncate">{item.file.name}</p>
                                                                    <button type="button" onClick={() => handleUpdateItem(index, 'file', null)} className="text-rose-500 hover:text-rose-600 text-[10px] font-black uppercase flex items-center gap-1 transition-colors shrink-0 ml-2">
                                                            ...
                                                            <div className="flex items-center gap-3 p-2 bg-white/5 border border-panel-border rounded-xl h-[36px]">
                                                                ...
                                                                <div className="flex-1 min-w-0 flex justify-between items-center">
                                                                    <p className="text-[10px] font-bold text-foreground truncate">Boleto Salvo</p>
                                                                    <div className="flex gap-3 shrink-0 ml-2">
                                                                        <a href={item.existingUrl} target="_blank" rel="noreferrer" className="text-primary hover:text-primary-hover text-[10px] font-black uppercase flex items-center gap-1 transition-colors">
                                                                            <ExternalLink className="w-3 h-3" /> Abrir
                                                                        </a>
                                                                        <button type="button" onClick={() => handleUpdateItem(index, 'existingUrl', null)} className="text-rose-500 hover:text-rose-600 text-[10px] font-black uppercase flex items-center gap-1 transition-colors">
                                                            ...
                                                            <label className="flex flex-col items-center justify-center w-full h-[36px] border border-dashed border-primary/30 rounded-xl cursor-pointer bg-primary/5 hover:bg-primary/10 transition-colors relative group">
                                                                <div className="flex items-center gap-2">
                                                                    ...
                                                                    <span className="text-[10px] text-primary font-bold uppercase tracking-widest">Anexar</span>
                                                                </div>
                                                    ...
                                                    <div className="col-span-1 md:col-span-3 space-y-2">
                                                        <label className="text-[10px] font-black text-text-dim uppercase tracking-widest ml-1">Vencimento</label>
                                                        <input
                                                            type="date"
                                                            value={item.vencimento}
                                                            onChange={(e) => handleUpdateItem(index, 'vencimento', e.target.value)}
                                                            className="w-full h-[36px] bg-white/5 border border-panel-border rounded-xl px-4 text-[10px] font-bold text-foreground focus:outline-none focus:border-primary transition-all [&::-webkit-calendar-picker-indicator]:invert-[0.5] dark:[&::-webkit-calendar-picker-indicator]:invert-0"
                                                        />
                                                    </div>

                                                    {/* Valor */}
                                                    <div className="col-span-1 md:col-span-4 space-y-2">
                                                        <label className="text-[10px] font-black text-text-dim uppercase tracking-widest ml-1">Valor do Boleto</label>
                                                        <div className="relative">
                                                            <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[10px] font-black text-accent">R$</span>
                                                            <input
                                                                type="text"
                                                                value={item.valor}
                                                                onChange={(e) => {
                                                                ...
                                                                className="w-full h-[36px] bg-white/5 border border-panel-border rounded-xl pl-9 pr-4 text-[10px] font-bold text-white focus:outline-none focus:border-primary transition-all"
                                                            />
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="flex justify-end pt-4">
                                            <button
                                                ...
                                                disabled={isSaving}
                                                className="h-12 px-6 bg-[#EAEAEA] text-[#0B0B0C] hover:scale-[1.02] disabled:opacity-50 rounded-xl font-bold uppercase tracking-wider transition-all flex items-center gap-2 shadow-lg shadow-black/20">
